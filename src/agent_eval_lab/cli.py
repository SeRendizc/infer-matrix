"""Command-line interface for Agent Eval Lab.
...
from agent_eval_lab.cases import EvalCase, load_case
from agent_eval_lab.reports import (
    ReportAssemblyError,
    ReportWriteError,
    RunReport,
    assemble_run_report,
...
app = typer.Typer(
    help="Agent Eval Lab: evaluation infrastructure for reliable agentic LLM systems.",
...
@app.callback()
def main() -> None:
    """Agent Eval Lab command line interface."""
    pass
...
def run(
    ...
    """运行一个 Agent Eval Lab Case 并生成报告。"""
    ...
    console.print(
        "[bold green]Agent Eval Lab case loaded[/bold green]"
    )
