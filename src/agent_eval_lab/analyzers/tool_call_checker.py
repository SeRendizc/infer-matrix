...
阶段 C-5 的目标：
检查 ParsedToolCallMessage 是否符合 EvalCase 中声明的预期。
...
from agent_eval_lab.parsers import (
    ParsedToolCall,
...
def _check_tool_name(case: EvalCase, tool_call: ParsedToolCall) -> ToolCallCheckResult:
