...
from agent_eval_lab.parsers.structured_output_parser import ParsedStructuredOutput
...
def check_json_schema(case: EvalCase, structured_output: ParsedStructuredOutput) -> SchemaCheckResult:
